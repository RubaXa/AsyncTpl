(function (utils, Parser, Compiler, Buffer, undef){
	...
	// @public
		fetch: function (){
			if( this._tpl === undef ){
				this._compile(this._filename, this.fetch.bind(this));
				return	this;
			}

			var _buf = new Buffer(this._opts.stream ? this._listeners.data : undef, this._listeners.end);
			this._tpl(this._data, _buf, utils);

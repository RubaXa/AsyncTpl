(function (){
	...
	var
		...
		, _rnum = /\d/
		, _invert = { '[': ']', '(': ')' }
		, _keywords = 'break else new var case finally return void catch for switch while continue function this with default if throw delete in try do instanceof typeof null true false'.split(' ')
	;

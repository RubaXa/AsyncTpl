...
(function (fs, undef){
	...
	function Defer(fn){
		...
		self.done	= function (fn){ if( _ok && fn !== undef ){ _end ? fn(_result) : _done.push(fn); } return self; };
		self.fail	= function (fn){ if( _err && fn !== undef ){ _end ? fn(_result) : _fail.push(fn); } return self; };

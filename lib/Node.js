...
(function (utils){
	...
	Node.prototype = {
		...
		attrAny: function (names, r){
			utils.each(names.split(' '), function (name){
				r = r || this.attributes[name];
			}, this);
			return	r;
		},
		...
		c: function (ns, name, attrs, closed){
			return	this.clone(ns, name, Node.COMPILER_NODE, attrs, closed)
		},

		clone: function (ns, node, type, attrs, closed){

...
[];Object.keys?c=Object.keys(a):m.each(a,function(a){c.push(a)});return c},each:function(a,c,g){if(a)if(a.forEach)a.forEach(c,g);else if("length"in a&&0 in a)for(var b=0,f=a.length;b<f;b++)b in a&&c.call(g,a[b],b,a);else for(b in a)a.hasOwnProperty(b)&&c.call(g,a[b],b,a)},cycle:function(a,c,g){for(;a<=c;a++)g(a)},trim:j?function(a){return j.call(a)}:function(a){return(""+a).replace(k,"").replace(z,"")},extend:function(a){a=a||{};this.each(arguments,function(c,g){0<g&&this.each(c,function(c,g){a[g]=
c})},this);return a},indexOf:function(a,c){if(a.indexOf)return a.indexOf(c);for(var g=0,b=a.length;g<b;g++)if(a[g]===c)return g;return-1},inherit:function(a,c,g,b){if(2===arguments.length){var f=function(){};f.prototype=c.prototype;a.prototype=new f;a.prototype.self=a;a.prototype.constructor=a;m.each(c,function(c,g){a[g]=c})}else return c.prototype[g].apply(a,b)},defer:d,load:function(a,c,g,b){var f=this.defer();c?e.readFile(a,g||"utf-8",function(a,c){f[a?"reject":"resolve"](a||c)}):f.resolve(o("fs").readFileSync(a,

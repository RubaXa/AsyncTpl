...
!0,g=!0,k=!1,h=this;h.done=function(a){e&&a!==f&&(k?a(d):p.push(a));return h};h.fail=function(a){g&&a!==f&&(k?a(d):m.push(a));return h};h.then=function(a,p){return h.done(a).fail(p)};h.reject=function(a){e=!1;k=!0;for(d=a;m.length;)m.shift()(a);return h};h.resolve=function(a){g=!1;k=!0;for(d=a;p.length;)p.shift()(a);return h};h.promise=function(){c===f&&(c={done:h.done,fail:h.fail,then:h.then,promise:h.promise});return c};a!==f&&a(h)}var c=Object.prototype.toString,d=String.prototype.trim,t=/^#/,
k=[].slice,u=/^\s+/,v=/\s+$/,i=/[&<>"]/g,n=/'/g,q={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"},l="undefined"!==typeof console&&console,j={Array:function(a){a=a||[];a.map=a.map||function(a){for(var m=[],b=0,c=this.length;b<c;b++)m.push(a(this[b]));return m};a.add=function(a,b,c){a.__order=~~c;b===f?this.push(a):0==b?this.unshift(a):this.splice(b,0,a);return this};a.addOrder=function(a,b){return this.add(a,f,b)};a.addMulti=function(a,b){a.length&&this.splice.apply(this,[b,0].concat(a));return this};

(function(j){function o(a,b){t[a.replace(u,"")]=b}function m(a){return t[a.replace(u,"")]}var u=/^.+\//,t={};o("fs",{readFile:function(a,b,c){jQuery.ajax({url:a,type:"get",dataType:"text",isLocal:!0,success:function(a){c(null,a)}})},readFileSync:function(a){return jQuery.ajax({url:a,type:"get",async:!1,dataType:"text",isLocal:!0}).responseText},lstatSync:function(){return{mtime:0}}});var k=m("fs"),h=function(){return(65536*(1+Math.random())|0).toString(16).substring(1)},i=function(a){if(!(this instanceof
...
(a[b]={});a=a[b]});a[d]=c},escape:function(a){if("string"===typeof a)D.test(a)&&(~a.indexOf("&")&&(a=a.replace(E,"&amp;")),~a.indexOf("<")&&(a=a.replace(G,"&lt;")),~a.indexOf(">")&&(a=a.replace(F,"&gt;")),~a.indexOf('"')&&(a=a.replace(H,"&quot;")));else if("undefined"===typeof a)return"";return a},addslashes:function(a){return a.replace(I,"\\'")},log:l&&"object"==typeof l.log?Function.prototype.call.bind(l.log,l):function(){l&&l.log.apply(l,arguments)},exception:function(a,b,c){throw{message:a,line:b,
file:c};},error:function(a,b,c){b="Error: "+a.message+" in "+(a.file||c)+" on line "+(a.line||b);a.stack&&(b+="\n"+a.stack);f.log(b);return b},keys:function(a){var b=[];Object.keys?b=Object.keys(a):f.each(a,function(a){b.push(a)});return b},each:function(a,b,c){if(a)if("length"in a&&0 in a)for(var d=0,e=a.length;d<e;d++)b.call(c,a[d],d,a);else for(d in a)a.hasOwnProperty(d)&&b.call(c,a[d],d,a)},cycle:function(a,b,c){for(;a<=b;a++)c(a)},trim:w?function(a){return w.call(a)}:function(a){return String(a).replace(B,
...
m("./utils"),q=function(a,b){this._data="";this._pullLen=0;this._active=true;this._stream=b;this._callback=a};q.prototype={constructor:q,uniqId:function(){return p.uniqId()},on:function(){this._active=true},off:function(){this._active=false},v:function(a){if(this._active)this._data=this._data+p.escape(a)},w:function(a){if(this._active)this._data=this._data+a},cycle:function(){this._active&&p.cycle.apply(p,arguments)},each:function(a,b){if(this._active&&a)if("length"in a&&0 in a)for(var c=0,d=a.length;c<
d;c++)b(a[c],c);else for(c in a)a.hasOwnProperty(c)&&b(a[c],c)},block:function(a,b,c){this.w(this.getBlock(a,b,c))},blockLabel:function(a,b,c){if(this._active){c!==void 0&&this.setBlock(a,c,true);if(this._blocks===void 0){this._chunks=[];this._blocks=[];this._attrs=[]}a=this._chunks.push(this._data,a)-1;this._blocks.push(a);b!==void 0&&(this._attrs[a]=b);this._data=""}},setBlock:function(a,b,c){if(this._block===void 0)this._block={};if(c!==true||this._block[a]===void 0)this._block[a]=b},getBlock:function(a,
b,c){this._block[a]!==void 0&&(c=this._block[a]);if(c!==void 0){a=new q;a._block=this._block;c(a,b);return a.toStr()}return""},pullSync:function(a,b,c){this.pull(a,b,c)},pull:function(a,b,c){if(this._pull===void 0)this._pull={};if(this._pull[b]===void 0){var d=p.defer(),e=function(){this._pullLen--;setTimeout(this.end.bind(this),0)}.bind(this);this._pullLen++;this._pull[b]=d.then(e,e);try{a[b](function(a,b){d[a?"reject":"resolve"](a||b)})}catch(f){d.reject(true)}}c!==void 0&&this._pull[b].then(function(a){c(null,
a)},function(a){c(a)});return this._pull[b].promise()},end:function(){if(this._stream){this._callback(this._data);this._data=""}if(this._pullLen===0){if(this._blocks!==void 0){for(var a=this._blocks,b=this._chunks,c=this._attrs,d=b.length,e=a.length,f;e--;){f=a[e];b[f]=this.getBlock(b[f],c[f])}a=b[--d];for(e=d;e--;)a=b[e]+a;this._data=a+this._data}this._callback!==void 0&&this._callback(this._data);this._stream&&this._callback(null)}},isActive:function(){return this._pullLen!==0},toStr:function(){return this._data}};
"undefined"!==typeof o?o("./Buffer",q):module.exports=q;var n=j.AsyncTpl=j.AsyncTpl||{},s=m("utils"),J=m("Buffer");j.__xtplFn=j.__xtplFn||{};n.mods=function(a){s.extend(s.mods,a)};n.require=m;n.fetch=function(a,b){return __xtplFn[a](b||{},new J,s)};n.get=function(a){return function(b){return n.fetch(a,b)}};var y=function(a){if(a){a.xtpl=function(a,c){return n.fetch(a,c)};a.fn.xtpl=function(b,c){if(this.length&&this[0].nodeType==1)this[0].innerHTML=a.xtpl(b,c);return this}}};j.define&&define.amd?define(["jquery"],
y):y(j.jQuery);j.ajs&&ajs.loaded("{AsyncTpl}AsyncTpl.core.min")})(this);
